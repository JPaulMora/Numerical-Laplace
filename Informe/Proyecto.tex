...
de potenciales electricos resolviendo la Ecuación de Laplace con condiciones de
...
\begin{figure}
  ...
  \caption{Configuración de las condiciones de frontera \(h(y) = tan^{-1}(y/a)\)}
  \label{arctan-n20}
\end{figure}
...
\begin{figure}
  ...
  \includegraphics[width=1.5in]{images/arctan-density-n0}
...
Así como el ejercicio anterior, presentamos el mapa de calor de la iteración \(n=20\) en la figura \ref{2y3-n20} seguido de 
las iteraciones menores y condiciones iniciales (figura \ref{2y3-iterations}).
